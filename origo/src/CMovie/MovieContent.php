...
EOD;
    ...
    public function editFilmInDb($params, $genres)
    {
        ...
        if ($res) {
            $output = $this->editGenres($params[16], $genres);
        } else {
